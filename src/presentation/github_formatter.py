...
def format_risk_assessment_comment(result: "RiskAssessmentResult") -> str:
    ...
    from src.event_processors.risk_assessment.signals import _SEVERITY_ORDER
    ...
    if not result.signals:
        ...
        sorted_signals = sorted(result.signals, key=lambda s: _SEVERITY_ORDER.get(s.severity, 0), reverse=True)
